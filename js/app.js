// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["ruyi", "bfzy", "tyyszy", "zy360", "iqiyi", "wolong", "jisu", "dbzy", "mdzy", "zuid", "yinghua", "baidu", "wujin", "wwzy", "ikun", "lzi", "qiqi"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["ruyi", "bfzy", "tyyszy", "zy360", "iqiyi", "wolong", "jisu", "dbzy", "mdzy", "zuid", "yinghua", "baidu", "wujin", "wwzy", "ikun", "lzi", "qiqi"];
